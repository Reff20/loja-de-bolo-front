...
function Header(): ReactElement {
  ...
  return (
    <div>
      ...
      <div className={`pt-[4rem] fixed w-screen ${!isOpen && '-translate-y-full'} ease-in duration-300`}>
      {
          isOpen && <div className={`bg-blue-50 h-[calc(100vh-4rem)] flex flex-col justify-between `}>
        <div className="space-y-10 px-7 py-7 ">
          <div className="flex items-center space-x-3">
            <GiCupcake className="text-[#2C89FF] text-xl" />
            <h1 className="text-[#2C89FF] text-xl">Bolos</h1>
          </div>
          <div className="flex items-center space-x-3">
            <GiPieSlice className="text-[#2C89FF] text-xl" />
            <h1 className="text-[#2C89FF] text-xl">Tortas</h1>
          </div>
          <div className="flex items-center space-x-3">
            <GiFrenchFries className="text-[#2C89FF] text-xl" />
            <h1 className="text-[#2C89FF] text-xl">Salgados</h1>
          </div>
          <div className="flex items-center space-x-3">
            <GiWaterBottle className="text-[#2C89FF] text-xl" />
            <h1 className="text-[#2C89FF] text-xl">Bebidas</h1>
          </div>
        </div>
        <h1 className="text-center text-[#2C89FF]">©Fernando Peres Carvalho</h1>
      </div>
      }
      </div>
    </div>
